		...
		<view class="scrollBox">
			<view class="wrap">
				<view class="wTop">
					...
					<view class="wtRight">
						<text>签到规则</text>
						<image src="@/pagesFunc/static/right-arrow.png" class="icon" mode=""></image>
					</view>
				</view>
				<view class="wMiddle">
					<view :class="index==6&&!item.isSign?'sp':item.isSign&&index!=6?'item active':item.isSign&&index==6?'sp active':'item'" v-for="(item,index) in signList" :key="index">
						<block v-if="index==6">
							...
							<view class="right">
								<image src="@/pagesFunc/static/box.png" class="icon" mode=""></image>
							</view>
						</block>
						<block v-else>
							<text class="date">{{item.date}}</text>
							<image src="@/pagesFunc/static/money.png" class="icon" mode=""></image>
