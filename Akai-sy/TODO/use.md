...
* z-paging的`下拉刷新`和`上拉加载`案例在`pagesIndex/index/index.vue`中有示例代码！并在此文件中附有详细说明。
...
* 在`pages/index/index.vue`中，有关于animate.css的使用，您可以在style中根据类名设置运行规律以及持续时间。
* 您可以查阅[animate.css](https://animate.style/)文档获取更多特效案例。
#### 3.lodash.js说明
* 在`pages/func/func.vue`文件中有关于lodash的简单实用案例说明。
...
* 在`pagesIndex`文件夹中的`index/index.vue`文件中有请求示例代码。
```javascript
	onShow(){
...
#### 11.关于uView-Ui，请查阅官方文档！
* [图鸟UI官网文档](https://www.uviewui.com/)，或加入官方交流群！
