	...
	<view class="container">
		...
		<view :class="isSHowNav?'active navFixed':'navFixed'">
			...
			<view class="navContent" :style="{height:navBarHeight+'px',width:searchBoxWidth+'px'}">
				<view class="leftIcon" @click="goBack">
					<image v-if="!isSHowNav" src="@/static/images/back-w.png" class="backIcon" mode=""></image>
					<image v-else src="@/static/images/back-b.png" class="backIcon" mode=""></image>
				</view>
		...
		<view :class="tabCurrent==0?'isMask content':'content'">
			<view :class="tabCurrent==0?'banner isMask':'banner'">
				...
				<view class="radio">
					<text>15s''</text>
					<image src="@/static/images/radio.png" class="rIcon" mode=""></image>
				</view>
			</view>
			<view class="user">
				<view class="uHeader">
				...
				<view class="uInfo">
					...
					<view class="uBottom">
						<view class="ubItem">
							<image src="@/static/images/star.png" class="icon" mode=""></image>
							<text>优质</text>
						</view>
						<view class="ubItem">
							<image src="@/static/images/follow.png" class="icon" mode=""></image>
							<text>官方认证</text>
						</view>
						<view class="ubItem">
							<image v-if="isSHowNav" src="@/static/images/woman.png" class="icon" mode=""></image>
							<image v-else src="@/static/images/man.png" class="icon" mode=""></image>
							<text>23</text>
						</view>
						<view class="ubItem">
							<image src="@/static/images/level.png" class="icon" mode=""></image>
							<text>1030</text>
						</view>
					</view>
				</view>
				...
				<view class="twoItem" v-for="(item,index) in trendsList" :key="index">
					<view class="tTop">
						...
						<view class="zp">
							...
							<view class="zpItem">
								<image src="@/static/images/zan-me.png" mode=""></image>
								<text>{{item.zan}}</text>
							</view>
						</view>
					</view>
	...
	export default {
		data() {
			return {
				...
				bottomList:[
					{name:'关注',img:'../../../static/images/follow.png'},
					{name:'私聊',img:'../../../static/images/message.png'},
					{name:'视频',img:'../../../static/images/video.png'},
					{name:'搭讪',img:''},
				],
				trendsList:[
