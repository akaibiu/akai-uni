<template>
	<view class="container">
		<view class="recruit">
			...
			<view class="badge">
				<view class="bItem">
					<image src="@/pagesJob/static/position.png" class="bIcon" mode=""></image>
					<text>广州-天河区</text>
				</view>
				<view class="bItem">
					<image src="@/pagesJob/static/experience.png" class="bIcon" mode=""></image>
					<text>经验不限</text>
				</view>
				<view class="bItem">
					<image src="@/pagesJob/static/edu.png" class="bIcon" mode=""></image>
					<text>学历不限</text>
				</view>
			</view>
			<view class="hr">
				...
				<view class="right">
					<image src="@/pagesJob/static/arrow.png" class="arrow" mode=""></image>
				</view>
			</view>
		</view>
		<view class="bigTitle">
		...
		<view class="bottom">
			<view class="item">
				<image src="@/pagesJob/static/share.png" class="share" mode=""></image>
				<text>分享</text>
			</view>
			<view class="item">
				<image src="@/pagesJob/static/collect.png" class="collect" mode=""></image>
				<text>收藏</text>
			</view>
			<view class="talk">
				立即沟通
