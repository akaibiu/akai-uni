		...
		<view class="scrollBox">
			<view class="wrap">
				<view class="wTop">
					...
					<view class="wtRight">
						<text>签到规则</text>
						<image src="@/static/images/right-arrow.png" class="icon" mode=""></image>
					</view>
				</view>
				<view class="wMiddle">
					<view :class="index==6&&!item.isSign?'sp':item.isSign&&index!=6?'item active':item.isSign&&index==6?'sp active':'item'" v-for="(item,index) in signList" :key="index">
						<block v-if="index==6">
							...
							<view class="right">
								<image src="@/static/images/box.png" class="icon" mode=""></image>
							</view>
						</block>
						<block v-else>
							<text class="date">{{item.date}}</text>
							<image src="@/static/images/money.png" class="icon" mode=""></image>
		...
		data() {
			return {
				...
				toList: [{
						...
						tip: '任务奖励',
						info: '+100积分',
						icon: '../../../static/images/wc.png',
					},
					{
						name: '完善会员信息',
						tip: '任务奖励',
						info: '+100积分',
						icon: '../../../static/images/id.png'
					},
					{
						name: '添加企业微信',
						tip: '任务奖励',
						info: '+200积分',
						icon: '../../../static/images/c-w.png'
					},
					{
						name: '邀请好友',
						tip: '任务奖励',
						info: '+200积分',
						icon: '../../../static/images/add-sign.png'
					},
					{
						name: '阅读精彩文章',
						tip: '任务奖励',
					...
					},
					{
						...
						tip: '任务奖励',
						info: '+10积分',
						icon: '../../../static/images/zan-sign.png'
					},
				]
			}
		},
